...
export default function Sports({ navigation }) {
    ...
    const FocusArea = [
        ...
        { "id": '3', "name": "Flexibility", "img": "https://th.bing.com/th/id/OIP.hZgfBQOfZVJntIQuzSyjKAHaD8?rs=1&pid=ImgDetMain" },
        ...
        <SafeAreaView style={[styles.container, isDarkMode && styles.darkContainer]}>
            <ScrollView>
                ...
                <View style={[styles.FocusAreaContainer, isDarkMode ? { backgroundColor: 'black', } : null]}>
                    ...
                    <View style={[styles.FocusAreaListContainer, isDarkMode ? { shadowColor: 'gray', } : null]}>
                        <FlatList
